          ...
          >
            <div className="space-y-3">
              ...
              {!imageSrc && !croppedImage && (
                <label className="flex min-h-[220px] cursor-pointer flex-col items-center justify-center rounded-3xl border border-dashed border-gray-300 bg-gray-50/70 px-6 text-center transition hover:border-gray-400 hover:bg-gray-50">
            ...
            {imageSrc && !croppedImage && (
              <div className="space-y-5 rounded-3xl border border-gray-200 bg-gray-50 p-4 sm:p-5">
                      ...
                      {INSTAGRAM_CROP_PRESETS.map((preset) => {
                        ...
                        return (
                          ...
                          >
                            ...
                            {isSelected && (
                              <div className="absolute right-2 top-2 flex h-5 w-5 items-center justify-center rounded-full bg-white text-gray-900 sm:right-3 sm:top-3">
                                <Check size={13} />
                              </div>
                            )}
                          </button>
            ...
            {croppedImage && (
              <div className="space-y-4 rounded-3xl border border-gray-200 bg-gray-50 p-4 sm:p-5">
                ...
                <div className="w-full max-w-[420px] overflow-hidden rounded-2xl border border-gray-200 bg-white">
                  <img
                    src={croppedImage}
                    alt="Imagem final"
            ...
            <div className="grid gap-6">
              ...
              <div className="relative space-y-2">
                ...
                <input
                  ...
                  className={`w-full rounded-2xl border bg-white px-4 py-3 pr-10 text-sm text-gray-900 outline-none transition-all ${
                    errors.category
                      ? "border-red-400 focus:border-red-500 focus:ring-4 focus:ring-red-100"
                      : "border-gray-200 focus:border-gray-900 focus:ring-4 focus:ring-gray-100"
                  }`}
                ...
                <span className="pointer-events-none absolute right-4 top-[52px] text-sm text-gray-400">
                  ▼
                </span>

                {isCategoryOpen && (
                  <div className="absolute z-20 mt-1 max-h-56 w-full overflow-y-auto rounded-2xl border border-gray-200 bg-white p-1 shadow-xl shadow-gray-200/50">
